...
(function ($) {
    ...
    Filestyle.prototype = {
        ...
        classButton: function (value) {
            if (value !== undefined) {
                ...
                if (this.options.classButton.search(/btn-inverse|btn-primary|btn-danger|btn-warning|btn-success/i) !== -1) {
                    this.$elementFilestyle.find('label span').addClass('glyphicon');
                } else {
                    this.$elementFilestyle.find('label span').removeClass('glyphicon');
                }
            } else {
        ...
        classIcon: function (value) {
            if (value !== undefined) {
                ...
                if (this.options.classButton.search(/btn-inverse|btn-primary|btn-danger|btn-warning|btn-success/i) !== -1) {
                    this.$elementFilestyle.find('label').find('i').attr({'class': 'glyphicon '+this.options.classIcon});
                } else {
    ...
    $.fn.filestyle.defaults = {
        ...
        'classIcon': 'glyphicon-folder-open'
    };
